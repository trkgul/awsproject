...
DATABASES = {
    'default': {
        ...
        'HOST': 'awsproject-rds.c53v42j49kqa.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsprojectmuharremblog' # please enter your s3 bucket name
